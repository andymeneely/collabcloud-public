...
public class RepoCloudPropertyPage extends PropertyPage {
	...
	public boolean performOk() {
		...
		try {
			((IResource) getElement())
					.setPersistentProperty(new QualifiedName("", OWNER_PROPERTY), ownerText.getText());
		} catch (CoreException e) {
			return false;
		}
		return true;
