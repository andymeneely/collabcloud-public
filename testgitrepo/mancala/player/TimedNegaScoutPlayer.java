...
public class TimedNegaScoutPlayer implements IPlayer {
	...
	@Override
	public int getPlay(Board state) {// Making a modification for the sake of testing
		int bestScore = Integer.MIN_VALUE; // Another modification
		int bestPlay = -1; //Yet another modification
